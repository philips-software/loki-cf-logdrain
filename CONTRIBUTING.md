# Contributing to the loki-cf-logdrain

We'd love for you to contribute to our source code and to make this logdrainer even better than it is today!
...
If you have questions about how to use the HSDP terraform provider, please direct these to the #terraform channel on HSDP Slack or open a [discussion](https://github.com/philips-software/loki-cf-logdrain/discussions).
...
In Github, send a pull request to original main branch: f.e. `loki-cf-logdrain:main`.
...
[github]: https://github.com/philips-software/loki-cf-logdrain/issues 
